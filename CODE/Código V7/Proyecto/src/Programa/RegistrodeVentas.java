...
public class RegistrodeVentas extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (fila >= 0) {
            ...
            String nuevoPrecio = jTextField2.getText();
            ...
            if (nuevaCantidad.matches("^\\d+$") && Integer.parseInt(nuevaCantidad) > 0
                   && nuevoPrecio.matches("^\\d+(\\.\\d{0,2})?$") && nuevoPrecio.replaceAll("[^.]", "").length() <= 1) {

                jTable1.setValueAt(nuevaCantidad, fila, 2);
                jTable1.setValueAt(nuevoPrecio, fila, 3);

                JOptionPane.showMessageDialog(this, "Registro actualizado correctamente.");
            } else {
                JOptionPane.showMessageDialog(this, "El formato de cantidad o precio es inválido.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
