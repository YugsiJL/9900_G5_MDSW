...
public class RegistrodeVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton6.setText("Generar y Ver Reporte");
        ...
        jButton8.setText("Archivo de Reportes");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            String fechaHoraActual = dateTimeFormat.format(dateTime);
            ...
            String rutaDocumentos = System.getProperty("user.home") + "\\Documents\\Registro De Ventas\\";
            ...
            // Fecha actual
            Paragraph fecha = new Paragraph("Fecha del registro: " + fechaHoraActual);
            document.add(fecha);
            ...
            JOptionPane.showMessageDialog(this, "El PDF se ha generado correctamente como ''" + nombreArchivo + "'' en la carpeta dentro de Documentos ");
            
            // Obtener la ruta del archivo PDF generado
            String rutaArchivo = System.getProperty("user.home") + "\\Documents\\Registro De Ventas\\" + "RegistroDeVentas_" + fechaActual + ".pdf";
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        try {
            // Obtener la ruta del directorio de guardado de los PDFs
            String rutaDocumentos = System.getProperty("user.home") + "\\Documents\\Registro De Ventas\\";
            // Abrir el directorio
            File archivo = new File(rutaDocumentos);
            Desktop.getDesktop().open(archivo);
        } catch (IOException e) {
            JOptionPane.showMessageDialog(RegistrodeVentas.this, "Error al abrir el directorio: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
